...
class Printer {
  ...
  async print(module, content) {
    ...
    const printName = async(section) => {
      ...
      await hook(EXIT, {name:"name", section, meta})
      return outputName
    }
    ...
    const printDescription = async(section) => {
      ...
      const outputDescription = section.description?.length
        ...
        : ""
      await hook(EXIT, {name:"description", section, meta})
    ...
    const printParams = async(section) => {
      ...
      await hook(EXIT, {name:"param", section, meta})
      return outputParams
    }
    ...
    const printReturns = async(section) => {
      ...
      await hook(EXIT, {name:"return", section, meta})
    ...
    const printExample = async(section) => {
      ...
      const outputExample = section.example?.length
        ...
        : ""
      await hook(EXIT, {name:"example", section, meta})
    ...
    await hook(END, {module, content, output})
