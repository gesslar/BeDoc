export const actions = [
  {
    ...
    async run({module, content}) {
      ...
      const printName = async(section) => {
        await hook(ENTER, {module, section, name: "name"})
      ...
      const printDescription = async(section) => {
        await hook(ENTER, {module, section, name: "description"})
      ...
      const printParams = async(section) => {
        await hook(ENTER, {module, section, name: "param"})
        const outputParams = []
      ...
      const printReturns = async(section) => {
        await hook(ENTER, {module, section, name: "return"})
      ...
      const printExample = async(section) => {
        await hook(ENTER, {module, section, name: "example"})
