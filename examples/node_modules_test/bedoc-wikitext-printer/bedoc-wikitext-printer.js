export const actions = [
  {
     ...
     * @param {string} module.moduleName The module name (base name) of the file
     * @param {object[]} module.moduleContent An array of objects containing function definitions.
    ...
    async run(module) {
       ...
       * @param {(sectionContent: unknown) => string} formatContent - Callback to format the content
