export const actions = [
  {
    ...
    async print(module, content) {
      ...
      const printName = async section => {
        ...
        const outputResult = await hook(EXIT, {name: "name", content: outputName})
      ...
      const printDescription = async section => {
        ...
        const outputDescription = section.description?.length
          ...
          : ""
        const outputResult = await hook(EXIT, {name: "description", content: outputDescription})
      ...
      const printParams = async section => {
        ...
        const outputResult = await hook(EXIT, {name: "param", content: outputParams})
      ...
      const printReturns = async section => {
        ...
        const outputResult = await hook(EXIT, {name: "return", content: outputReturns})
      ...
      const printExample = async section => {
        ...
        const outputExample = section.example?.length
          ...
          : ""
        const outputResult = await hook(EXIT, {name: "example", content: outputExample})
      ...
      const outputResult = await hook(END, {module, content, output: output.join("\n\n")})
