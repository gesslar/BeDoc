export const actions = [
  {
    ...
    patterns: {
      ...
      tagContent:
        ...
        /^(?<name>.*) (?<type>.*) - (?<content>.+)$/,
      // returnContent: /^\s*(?<type>[\w|[\]]+(?:\s*\|\s*[\w|[\]]+)*)\s+#\s+(?<content>.*)?$/,
     ...
     * @param {string} module.module The file name to parse.
     * @param {object} module.content The content of the file to parse.
    ...
    determineFunctionName(line) {
      ...
      if(!match)
        throw new Error(`Failed to extract function from line: ${line}`)
