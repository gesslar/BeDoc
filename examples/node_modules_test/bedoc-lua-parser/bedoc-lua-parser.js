export const actions = [
  {
    ...
    tags: {
      ...
      isValid: tag =>
        this.tags.all.includes(tag) ||
          Object.keys(this.tags.convert).includes(tag) ||
          Object.values(this.tags.convert).includes(tag)
      ,
    },
    ...
    init(config) {
      ...
      this.regex = {
        ...this.patterns,
        tag: new RegExp(`^\\s*---@(?<tag>${[...this.tags.all].join("|")})\\s?(?<content>.*)$`),
      }
    },
